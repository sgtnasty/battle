...
namespace Battle.Core
{
	public abstract class Provider
	{
		...
		public bool Provides(string query)
		{
			return this.provides.Contains(query);
		}
		public bool Requires(string query)
		{
			return this.requires.Contains(query);
		}
	}
}
